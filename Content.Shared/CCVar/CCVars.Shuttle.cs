...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> EmergencyRecallTurningPoint =
        CVarDef.Create("shuttle.recall_turning_point_green", 0.075f, CVar.SERVERONLY);

    public static readonly CVarDef<float> EmergencyRecallTurningPointForBlue =
        CVarDef.Create("shuttle.recall_turning_point_blue", 0.15f, CVar.SERVERONLY);

    public static readonly CVarDef<float> EmergencyRecallTurningPointForRed =
        CVarDef.Create("shuttle.recall_turning_point_red", 0.3f, CVar.SERVERONLY);
